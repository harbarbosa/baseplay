...
<div class="bp-card" style="margin-bottom:18px;">
    <div class="bp-card-body">
        <div style="display:grid; gap:14px; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
            ...
            <div class="bp-card" style="padding:14px;">
                <div style="color:var(--muted); font-size:12px;">Pendencias de documentos (7 dias)</div>
                <div style="font-size:26px; font-weight:700; color:var(--primary);"><?= esc($kpis['pending_documents'] ?? 0) ?></div>
            </div>
            <div class="bp-card" style="padding:14px;">
                <div style="color:var(--muted); font-size:12px;">Baixa presenca (30 dias)</div>
...
<?php if (has_permission('attendance.manage') || has_permission('reports.view')): ?>
    <div class="bp-card" style="margin-bottom:18px;">
        <div class="bp-card-body">
            <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; margin-bottom:12px;">
                <div>
                    <h2 style="margin:0;">Atletas com baixa presenca</h2>
                    <div style="color:var(--muted); font-size:12px;">Abaixo de 60% nos ultimos 30 dias.</div>
                </div>
                <?php if (has_permission('reports.view')): ?>
                    <a class="bp-btn-secondary" href="<?= base_url('/reports/attendance') ?>">Ver relatorio</a>
                <?php endif; ?>
            </div>
            <div class="bp-table-wrap">
                <table class="bp-table">

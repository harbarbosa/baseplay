            ...
            <tr>
                ...
                <td>
                    <div class="bp-action-buttons">
                        <a href="<?= base_url('/notices/' . $notice['id']) ?>" class="bp-icon-btn" title="Detalhar" aria-label="Detalhar">
                        ...
                        <?php if (has_permission('notices.update')): ?>
                            <a href="<?= base_url('/notices/' . $notice['id'] . '/edit') ?>" class="bp-icon-btn" title="Editar" aria-label="Editar">
                        ...
                        <?php if (has_permission('notices.delete')): ?>
                            <a href="<?= base_url('/notices/' . $notice['id'] . '/delete') ?>" class="bp-icon-btn bp-icon-danger" title="Excluir" aria-label="Excluir">

...
<div class="card" style="max-width:900px;">
    <h1>Novo plano</h1>
    <form method="post" action="<?= base_url('/training-plans') ?>">
        <?= csrf_field() ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="goal" value="<?= esc(old('goal')) ?>">
        </div>

        <div class="form-group">
            <label>Data planejada</label>
            <input type="date" name="planned_date" value="<?= esc(old('planned_date')) ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <select name="status">
                ...
                <option value="ready" <?= old('status') === 'ready' ? 'selected' : '' ?>>Pronto</option>

            ...
            <tr>
                ...
                <td>
                    <div class="bp-action-buttons">
                        <a href="<?= base_url('/guardians/' . $guardian['id']) ?>" class="bp-icon-btn" title="Detalhar" aria-label="Detalhar">
                        ...
                        <?php if (has_permission('guardians.update')): ?>
                            <a href="<?= base_url('/guardians/' . $guardian['id'] . '/edit') ?>" class="bp-icon-btn" title="Editar" aria-label="Editar">
                        ...
                        <?php if (has_permission('guardians.delete')): ?>
                            <form method="post" action="<?= base_url('/guardians/' . $guardian['id'] . '/delete') ?>" class="bp-inline-form" onsubmit="return confirm('Excluir este responsável?');">
                                <?= csrf_field() ?>
